...
int main() {
  ...
  net << tiny_dnn::fully_connected_layer(1, 10, false, tiny_dnn::core::backend_t::opencl);
  net << tiny_dnn::tanh_layer();
  net << tiny_dnn::fully_connected_layer(10, 10, false, tiny_dnn::core::backend_t::opencl);
  net << tiny_dnn::tanh_layer();
  net << tiny_dnn::fully_connected_layer(10, 1, false, tiny_dnn::core::backend_t::opencl);
