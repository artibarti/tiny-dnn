...
inline generate_gradient_check_data(size_t input_dimension,
  size_t sample_count = 5, size_t class_count  = 2) {
...
std::vector<tensor_t> generate_test_data(const std::vector<size_t> nsamples, const std::vector<size_t> sizes) {
